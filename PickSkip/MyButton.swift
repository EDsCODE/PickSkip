...
class MyButton: UIButton {
    ...
    override public init(frame: CGRect) {
        ...
        self.addTarget(self, action: #selector(MyButton.didTouchDown), for: .touchDown)
        self.addTarget(self, action: #selector(MyButton.didTouchUp), for: .touchUpInside)
        self.addTarget(self, action: #selector(MyButton.didTouchUp), for: .touchUpOutside)
